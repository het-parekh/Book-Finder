        ...
        <>
            <div className='flex justify-center py-5'>
                <ul className='inline-flex' >
                    ...
                    <li onClick={() => handleChangePage(Math.min(currentPage+1,props.totalPages))} title="Next Page" class='m-auto mr-1 ml-1 py-1 px-2 border border-solid  border-theme-green transition hover:bg-theme-green duration-400 ease-in-out hover:cursor-pointer'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
